...
export const landingPages: LandingPageData[] = [
  {
    ...
    metaDescription:
      'MS pipes dealer in Ahmedabad — Jindal ERW, GI hollow sections, spiral pipes, fittings & flanges from Vatva & Rakhial. Free quote. Call +91 9601702883.',
    keywordsSlug: 'home',
    eyebrow: 'Ahmedabad · Gujarat',
    heroTitle: 'MS pipes dealer in Ahmedabad',
    heroDescription:
      'Authorized Jindal channel partner with Vatva office and Rakhial stockyard — 15 MM to 500 MM pipe range.',
    sections: [
      {
        heading: 'Your MS pipe stockist in Vatva & Rakhial',
        paragraphs: [
          ...
          'We hold stock at <strong class="font-semibold text-navy-brand">GIDC Vatva</strong> and our <strong class="font-semibold text-navy-brand">Rakhial stockyard</strong> for faster dispatch on project schedules. Request a detailed free quotation with NB, wall thickness, grade and delivery location.',
        ],
      },
      {
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'Orders are confirmed against Ahmedabad yard stock at Vatva and Rakhial with mill documentation available on request. We dispatch across Ahmedabad, Surat, Vadodara, Rajkot and nationwide project sites.',
        ],
      },
      {
  ...
  },
  {
    ...
    metaDescription:
      'GI pipe dealers in Ahmedabad — Jindal GI square & rectangular hollow sections, Asian pipes stock. Navkar Tubes, Vatva & Rakhial. Free quote.',
    keywordsSlug: 'products',
